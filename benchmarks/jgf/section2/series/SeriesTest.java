...
// This is the Thread
primitive class SeriesRunner implements Runnable {
    ...
    public void run() {
        ...
        if (id == 0) {
            SeriesTest.TestArray[0][0] = // Lower bound.
            TrapezoidIntegrate(// Lower bound.
            (double) 0.0, // Upper bound.
            (double) 2.0, // # of steps.
            1000, // No omega*n needed.
            (double) 0.0, 0) / // 0 = term A[0].
            (double) 2.0;
        }
        ...
        for (int i = ilow; i < iupper; i++) {
            ...
            // out.
            SeriesTest.TestArray[0][i] = TrapezoidIntegrate((double) 0.0, (double) 2.0, 1000, omega * (double) i, // 1 = cosine term.
            1);
            // Calculate the B[i] terms.
            SeriesTest.TestArray[1][i] = TrapezoidIntegrate((double) 0.0, (double) 2.0, 1000, omega * (double) i, // 2 = sine term.
            2);
        }
    }
...
*/
    ...
    double // Lower bound.
    TrapezoidIntegrate(// Lower bound.
    double x0, // Upper bound.
    double x1, // # of steps.
    int nsteps, // omega * n.
    double omegan, // Term type.
    int select) {
...
*/
    ...
    thefunction(// Independent variable.
    double x, // Omega * term.
    double omegan, // Choose type.
    int select) {
